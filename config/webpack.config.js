/* eslint-disable camelcase, security/detect-non-literal-fs-filename, node/no-process-env, node/no-sync */
'use strict';
				...
				{parser: {requireEnsure: false}},
				{
                    ...
                    && require.resolve('react-refresh/babel'),
						...
						// that fall through the other loaders.
						{
							...
							exclude: [/\.(?:js|mjs|jsx|ts|tsx)$/u, /\.html$/u, /\.json$/u],
							options: {
								name: 'static/media/[name].[hash:8].[ext]',
							},
						},
...
/* eslint-enable camelcase, security/detect-non-literal-fs-filename, node/no-process-env, node/no-sync */
