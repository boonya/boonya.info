...
function Article({title, md, description, keywords, ...props}: ReturnType<typeof getArticles>[number]) {
  const date = new Date(props.date);

  return (
    <RootLayout title={title} description={description} keywords={keywords?.join(', ')}>
      <main>
